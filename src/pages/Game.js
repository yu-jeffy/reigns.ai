...
const Game = () => {
    ...
    const systemPrompt = `
        ...
        There are {numberOfChoices} choices to be made this turn, affecting the following categories: ${formatCategories()}.\n
        The difficulty level is set to "${settings.difficulty}".\n
        Generate a scenario for this turn, followed by ${settings.numberOfChoices} choices.\n
